<x-layouts::base :title="$title ?? null">
    ...
    <div
        class="relative flex-col items-center justify-center px-8 grid h-dvh sm:px-0 lg:max-w-none lg:grid-cols-2 lg:px-0">
        <div
            class="relative flex-col hidden h-full p-10 text-white bg-muted lg:flex dark:border-e dark:border-neutral-800">
        ...
        <div class="w-full lg:p-8">
            <div class="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
                <a href="{{ route('home') }}" class="z-20 flex flex-col items-center font-medium gap-2 lg:hidden"
                    wire:navigate>
